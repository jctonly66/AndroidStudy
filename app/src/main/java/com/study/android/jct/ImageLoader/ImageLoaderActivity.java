...
public class ImageLoaderActivity extends Activity implements AbsListView.OnScrollListener{
    private static final String TAG = "AnimatorActivty";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initData();
        initView();
        mImageLoader = ImageLoader.builder(ImageLoaderActivity.this);
    }
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        private ImageAdapter(Context context) {
            ...
            mDefaultBitmapDrawable = context.getResources().getDrawable(R.drawable.imageloader_default);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.item_gridview_imageloader,parent, false);
                holder = new ViewHolder();
                holder.imageView = (ImageView) convertView.findViewById(R.id.siv_imageloader);
